  ...
  export default {
    ...
    computed: {
      ...
      autocompleteKeywordCasing() {
        // The Settings UI wins; the ini config is the fallback.
        if (this.userKeywordCase) return this.userKeywordCase;
      ...
      autocompleteQuoteIdentifiers() {
        if (this.userQuoteIdentifiers) return this.userQuoteIdentifiers;
